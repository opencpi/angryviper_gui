...
//	@Label(standard = "Name")
//	@Derived(text="${ input != null ? input : (output != null ? output : (bidirectional != null ? bidirectional : ( inout != null ? inout : 'new' )))}")
//	ValueProperty PROP_DER_NAME = new ValueProperty(TYPE, "Dername");
//	Value<String> getDerName();

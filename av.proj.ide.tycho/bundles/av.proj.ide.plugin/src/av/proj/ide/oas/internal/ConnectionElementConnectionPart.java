...
public class ConnectionElementConnectionPart extends DiagramConnectionPart {
	...
	public ConnectionElementConnectionPart(Instance src, Instance target, 
			ApplicationConnectionService service, ApplicationDiagramEventHandler handler) {
		this.src = src;
	...
	public void remove() {
		...
		Application app = (Application)this.connectionService.getDiagramEditorPagePart().getLocalModelElement();

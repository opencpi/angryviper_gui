...
import av.proj.ide.oas.InstanceProperty;

public class OASInstancePropertyXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(InstanceProperty.class);
		this.modelElementTypes[1] = new ElementType(InstanceProperty.class);

...
public class SlotSignalXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(Signal.class);
		this.modelElementTypes[1] = new ElementType(Signal.class);
		this.xmlElementNames = new QName[ this.modelElementTypes.length ];            

		if (this.xmlElementNames.length == 2) {
			this.xmlElementNames[0] = createQualifiedName("Signal", xmlNamespaceResolver);
			...
			this.xmlElementNames[1] = createQualifiedName("signal", xmlNamespaceResolver);
                                             ...
                                             final int position )
    {
        ...
        XmlElement newElement = parent.addChildElement( xmlElementName, refXmlElement );
        newElement.setChildNodeText("@platform", "", false);

...
public class OHADPortXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(ConnectionPort.class);
		this.modelElementTypes[1] = new ElementType(ConnectionPort.class);

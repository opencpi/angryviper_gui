...
public class OPSArgumentXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(Argument.class);
		this.modelElementTypes[1] = new ElementType(Argument.class);
		this.xmlElementNames = new QName[ this.modelElementTypes.length ];            

		if (this.xmlElementNames.length == 2) {
			this.xmlElementNames[0] = createQualifiedName("Argument", xmlNamespaceResolver);
			...
			this.xmlElementNames[1] = createQualifiedName("argument", xmlNamespaceResolver);

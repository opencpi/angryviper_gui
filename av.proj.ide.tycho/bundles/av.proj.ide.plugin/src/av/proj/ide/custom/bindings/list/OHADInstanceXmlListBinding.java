...
public class OHADInstanceXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		if (this.xmlElementNames.length == 2) {
			this.xmlElementNames[0] = createQualifiedName("Instance", xmlNamespaceResolver);
			...
			this.xmlElementNames[1] = createQualifiedName("instance", xmlNamespaceResolver);

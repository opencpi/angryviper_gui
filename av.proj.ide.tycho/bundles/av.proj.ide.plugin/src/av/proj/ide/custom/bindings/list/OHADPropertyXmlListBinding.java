...
import av.proj.ide.ohad.ApplicationProperty;

public class OHADPropertyXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(ApplicationProperty.class);
		this.modelElementTypes[1] = new ElementType(ApplicationProperty.class);
		this.xmlElementNames = new QName[ this.modelElementTypes.length ];            

		if (this.xmlElementNames.length == 2) {
			this.xmlElementNames[0] = createQualifiedName("Property", xmlNamespaceResolver);
			...
			this.xmlElementNames[1] = createQualifiedName("property", xmlNamespaceResolver);

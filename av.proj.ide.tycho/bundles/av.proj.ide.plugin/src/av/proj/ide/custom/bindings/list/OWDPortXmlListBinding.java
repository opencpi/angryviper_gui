...
import av.proj.ide.owd.rcc.Port;

public class OWDPortXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[1] = new ElementType(Port.class);

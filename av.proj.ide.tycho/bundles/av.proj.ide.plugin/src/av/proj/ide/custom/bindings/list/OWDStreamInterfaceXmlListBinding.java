...
import av.proj.ide.owd.hdl.StreamInterface;

public class OWDStreamInterfaceXmlListBinding extends StandardXmlListBindingImpl {
	...
	protected void initBindingMetadata() {
		...
		this.modelElementTypes[0] = new ElementType(StreamInterface.class);
		this.modelElementTypes[1] = new ElementType(StreamInterface.class);
		this.xmlElementNames = new QName[ this.modelElementTypes.length ];            

		if (this.xmlElementNames.length == 2) {
			this.xmlElementNames[0] = createQualifiedName("StreamInterface", xmlNamespaceResolver);
			...
			this.xmlElementNames[1] = createQualifiedName("streaminterface", xmlNamespaceResolver);

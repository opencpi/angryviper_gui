...
public class HdlPrimitiveLibraryValidator implements IValidator {
	
	private NewOcpiAssetWizardPage1 page;
	
	public HdlPrimitiveLibraryValidator(NewOcpiAssetWizardPage1 page) {
		super();
		this.page = page;
	}
	...
	public IStatus validate(Object arg0) {
		...
		if (value.length() == 0) {
			String err = "HDL Primitive Library name must be specified";
